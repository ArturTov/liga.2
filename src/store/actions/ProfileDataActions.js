...
export const choosesProfessionData = createAsyncThunk(
	...
	async (data, thunkAPI) => {
		...
		data.profession_and_experience[0].executor_profile_work_experiences = data.profession_and_experience[0].executor_profile_work_experiences.filter(
			el => el.working_place && el.recruitment_data && el.working_place,
		)
		try {
			const response = await instance.post(
				"v1/user/profession-and-experience",
				data,
			)
			return response.data
		} catch (e) {
...
export const verifyPhoneCode = createAsyncThunk(
	...
	async (data, thunkAPI) => {
		try {
			const response = await instance.post(
				"v1/user/phone-number-verification",
				{
...
export const updatePersonalData = createAsyncThunk(
	...
	async (data, thunkAPI) => {
		try {
			const response = await instance.post(
				"v1/user/update-executor-personal-data",
				data,
			)
			return response.data
		} catch (e) {
...
export const updateExecutorData = createAsyncThunk(
	...
	async (data, thunkAPI) => {
		try {
			const response = await instance.post(
				"v1/user/education-and-certificate",
				data,
			)
			return response.data
		} catch (e) {
